...
一个轻量级、可私有部署的个人任务管理应用。没有复杂的界面，没有繁琐的操作，打开即用，专注于「把事情做完」。

## 核心理念

**少即是多** — 砍掉一切干扰，只保留任务管理的核心功能：

- 📝 **任务管理**：创建、编辑、完成，一气呵成
- 📊 **进度追踪**：百分比进度条，直观掌握任务进展
- 🏷️ **标签分类**：灵活归类，快速筛选
- 📅 **日历视图**：按时间维度纵览所有任务
- 💡 **灵感白板**：随时记录闪现的想法
- 🔄 **重复任务**：日常习惯，自动循环
...
| 工具 | 问题 |
|------|------|
| Todoist / 滴答清单 | 高级功能付费，数据存储在第三方 |
| Notion | 功能臃肿，国内访问慢，学习成本高 |
| 开源方案（Vikunja等） | 部署复杂，需要 Docker，技术门槛高 |

**本项目的答案：**

| 特点 | 说明 |
|------|------|
| **极简设计** | 没有花哨功能，打开就能用，零学习成本 |
| **数据私有** | 部署在自己服务器，数据完全自主 |
| **部署简单** | 宝塔面板 + PHP，10 分钟搞定，无需 Docker |
| **完全免费** | 开源无限制，服务器成本约 ¥30/月 |
| **易于定制** | React + PHP + MySQL，代码简洁易懂 |
