            ...
            {calendarDays.map((day, index) => {
              ...
              return (
                <button
                  ...
                  className={`
                    relative p-2 min-h-[80px] rounded-lg border transition-all flex flex-col
                ...
                <div className="space-y-3 pr-2">
                  {selectedDateTasks.map(task => (
                    <div
                      ...
                      className="p-4 rounded-lg border border-gray-100 hover:border-primary/50 cursor-pointer transition-all hover:shadow-sm bg-white"
                    >
